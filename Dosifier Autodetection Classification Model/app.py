...
balanced_train = pd.read_csv('balanced_train.csv').set_index('SN').drop('Unnamed: 0', axis=1, errors='ignore')
test_data = pd.read_csv('test_data.csv').set_index('SN').drop('Unnamed: 0', axis=1, errors='ignore')
